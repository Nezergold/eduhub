...
import { RegistrarCourseHierarchy } from "./components/portal/RegistrarCourseHierarchy";
...
function AdminCourses() {
  const { courses, faculties, createFaculty, removeFaculty, editFaculty } = useAppData();
  ...
  return (
    <RegistrarCourseHierarchy
      key={selectedFaculty || "hierarchy-root"}
      initialFaculty={selectedFaculty || undefined}
      onManageFaculties={() => setShowManage(true)}
    />
  );
}
